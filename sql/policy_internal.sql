...
CREATE OR REPLACE PROCEDURE _timescaledb_internal.policy_retention_check(job_id INTEGER, config JSONB)
AS '@MODULE_PATHNAME@', 'ts_policy_retention_check'
LANGUAGE C;
...
CREATE OR REPLACE PROCEDURE _timescaledb_internal.policy_reorder_check(job_id INTEGER, config JSONB)
AS '@MODULE_PATHNAME@', 'ts_policy_reorder_check'
LANGUAGE C;
...
CREATE OR REPLACE PROCEDURE _timescaledb_internal.policy_compression_check(job_id INTEGER, config JSONB)
AS '@MODULE_PATHNAME@', 'ts_policy_compression_check'
LANGUAGE C;
...
CREATE OR REPLACE PROCEDURE _timescaledb_internal.policy_check_continuous_aggregate(job_id INTEGER, config JSONB)
AS '@MODULE_PATHNAME@', 'ts_policy_refresh_cagg_check'
LANGUAGE C;
